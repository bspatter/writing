...
For simplicity, we only consider the period in which the incoming
...
To compare our computational results and analysis consider the
...
\begin{figure}[h]
  ...
  \includegraphics[width=.38\textwidth]{./figs/lung_figs/circ_y0_dist}
