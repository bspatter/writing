...
% In this section, we describe the model problem and numerical
% experiments designed to investigate the fundamental fluid dynamics
% associated with acoustically-driven, perturbed liquid-gas
% interfaces. To develop a model problem, we 
...
through the pulmonary pleurae and a few mm of pleural fluid \hl{(CITE:
  %(https://en.wikipedia.org/wiki/Pleural_cavity#Pleural_fluid [2]):
