...
\begin{figure}[t]
  ...
  \caption{Dependence of the bubble dynamics on the gas contents
    ($G=100$ kPa). \subref{fig:usbe_bubble_pfpair_radius} History of
    the bubble radius for PFP (solid) and air (dashed). $R_0=1$
    $\mu$m; frequency: 3.5 MHz; peak negative pressure: 3.3
    MPa. \subref{fig:usbe_bubble_pfpair_temp} Maximum temperature for
...
\begin{figure*}[t]
  ...
  elasticity]{Dependence of the dimensionless maximum bubble radius on
    ...
    squares: bioeffects. \subref{fig:freq_tissue_Ca20} $G=5$
    kPa. \subref{fig:freq_tissue_Ca0,1} $G=1$ MPa.}
