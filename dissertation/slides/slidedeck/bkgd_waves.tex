\begin{frame}
  \frametitle{Shock-driven fluid-fluid interfaces have been studied extensively}
  \vspace*{-0.25cm}
  {\small \hfill%
    \begin{fminipage}{1.0\linewidth}
      \begin{figure}
        \centering
        \begin{tikzpicture}%
          ...
          \begin{scope}[x={(image.south east)},y={(image.north
              west)}]%
            \node[font=\tiny,right] at (0.15,-0.05)
            {\textcolor{black}{Adapted from \cite{Brouillette2002}}};%
          \end{scope}%
        \end{tikzpicture}%
        \hfill \centering
        \begin{tikzpicture}%
          ...
          \begin{scope}[x={(image.south east)},y={(image.north
              west)}]%
            \node[font=\tiny,right] at (0.05,-0.05)
            {\textcolor{black}{Adapted from \cite{Heifetz2015}}};%
          \end{scope}%
        \end{tikzpicture}%
      \end{figure}
    \end{fminipage}
    ...
    \item Shocks deposit baroclinic vorticity at perturbed
      fluid interfaces \citep{Drake2006}.\pause
    \item This vorticity drives the interface perturbation to grow.\pause
    \item This is the Richtymyer-Meshkov ``instability''.\pause
    \item Acoustic waves are different. They interact over a finite
      time-scale.
