\begin{frame} \frametitle{\vspace*{0.5cm}We hypothesize that US waves generate baroclinic vorticity at gas-liquid interfaces, driving deformation.}%
  \visible<2->{
...
%        +\left(\boldsymbol{u}\cdot\nabla\right)\boldsymbol{\omega}=% 
        \frac{D\boldsymbol{\omega}}{Dt}=%
        \cancelto{\orderof{0}}{\left(\boldsymbol{\omega}\cdot\nabla\right)\boldsymbol{u}}%
        -\boldsymbol{\omega}\left(\nabla\cdot\boldsymbol{u}\right)%
