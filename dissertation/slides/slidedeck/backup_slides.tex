\begin{frame}
  ...
  \vfill
\end{frame}
\input{./slidedeck/governing_eq_unabridged}
...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{./figs/circulation_multi-lag_nomarks_01-Jun-2017}%
    ~
    \includegraphics[width=0.22\textwidth]{./figs/interface_multi-lag_01-Jun-2017}%
    ~
    \includegraphics[width=0.22\textwidth]{./figs/a0_t1000_24-May-2017}%
    ~
    \includegraphics[width=0.22\textwidth]{./figs/alveolar_sac}%
    ~
  \end{figure}
  \begin{figure}
    \centering
    \def\svgwidth{0.22\textwidth}%
    \import{./figs/}{p0_vs_t_us_general.pdf_tex}%
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10,25,50_a03_strain_15-Jun-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10,25,50_a10_strain_15-Jun-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10,25,50_a30_strain_15-Jun-2017_dim}
  \end{figure}
  \begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10_a03,10,30_strain_15-Jun-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A25_a03,10,30_strain_15-Jun-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A50_a03,10,30_strain_15-Jun-2017_dim}
  \end{figure}
\end{frame}
...
\begin{frame}
  \begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10,25,50_a03_tauxy_07-Mar-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10,25,50_a10_tauxy_07-Mar-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10,25,50_a30_tauxy_07-Mar-2017_dim}
  \end{figure}
    \begin{figure}
    \centering
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A10_a3,10,30_tauxy_27-Feb-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A25_a3,10,30_tauxy_27-Feb-2017_dim}
    ~
    \includegraphics[width=0.22\textwidth]{./figs/rmawave_1_A50_a3,10,30_tauxy_27-Feb-2017_dim}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A10_a03_t500_rho_snapshots_printable}
      };%
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A10_a10_t500_rho_snapshots}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.06,0.9) {\textcolor{white}{$\rho(x,y)$}};%
        \node[font=\small,right] at (0.7,0.9) {\textcolor{white}{(b) $a_0=0.1\ell$}};%
        \node[font=\small,right] at (0.06,0.14) {\colorbox{airgray}{$t = 0.6~\mu$s}};% t/(\ell c_{air})=1
        \node[font=\small,right] at (0.26,0.14) {\colorbox{airgray}{$t = 6.0~\mu$s\quad}};%t/(\ell c_{air})=10
        \node[font=\small,right] at (0.475,0.14) {\colorbox{airgray}{$t = 60~\mu$s\quad}};%t/(\ell c_{air})=100
        \node[font=\small,right] at (0.685,0.14) {\colorbox{airgray}{$t = 288~\mu$s\quad}};%t/(\ell c_{air})=500
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A10_a30_t500_rho_snapshots}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.06,0.9) {\textcolor{white}{$\rho(x,y)$}};%
        \node[font=\small,right] at (0.7,0.9) {\textcolor{white}{(c) $a_0=0.3\ell$}};%
  ...
  \end{subfigure}
  \caption[Evolution of the interface for $p_a=1$ MPa ultrasound
  wave]{Evolution of the interface for $p_a=1$ MPa ultrasound
    wave. Density contours at $t=0.6, 6, 60,$ and $288~\mu$s for
    initial perturbation amplitudes \subref{fig:rho_snapshot_03}
    $a_0 = 0.03\ell$, \subref{fig:rho_snapshot_10} $a_0 = 0.1\ell$,
    and \subref{fig:rho_snapshot_30} $a_0 = 0.3\ell$.}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A50_a03_t500_rho_snapshots}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.06,0.9) {\textcolor{white}{$\rho(x,y)$}};%
        \node[font=\small,right] at (0.7,0.9) {\textcolor{white}{(a) $a_0=0.03\ell$}};%
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A50_a10_t500_rho_snapshots}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.06,0.9) {\textcolor{white}{$\rho(x,y)$}};%
        \node[font=\small,right] at (0.7,0.9) {\textcolor{white}{(b) $a_0=0.1\ell$}};%
  ...
  \begin{subfigure}[b]{0.9\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A50_a30_t500_rho_snapshots}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.06,0.9) {\textcolor{white}{$\rho(x,y)$}};%
        \node[font=\small,right] at (0.7,0.9) {\textcolor{white}{(c) $a_0=0.3\ell$}};%
  ...
  \end{subfigure}
  % 
  \caption[Evolution of the interface for $p_a=5$ MPa ultrasound
  wave]{Evolution of the interface for $p_a=5$ MPa ultrasound
    wave. Density contours at $t=0.6, 6, 60,$ and $288~\mu$s for
    initial perturbation amplitudes \subref{fig:rho_snapshot_03}
    $a_0 = 0.03\ell$, \subref{fig:rho_snapshot_10} $a_0 = 0.1\ell$,
    and \subref{fig:rho_snapshot_30} $a_0 = 0.3\ell$.}
...
\begin{frame}
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A50_a03_t005_tauxy_snapshots_dim_printable}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A50_a10_t005_tauxy_snapshots_dim_printable}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.2,0.9) {$\tau_{xy}$ (Pa)};%
        \node[font=\small,right] at (0.2,0.25) {$t = 2.9~\mu$s };%
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \begin{tikzpicture}%
      \node[anchor=south west,inner sep=0] (image) at (0,0) {
        \includegraphics[width=\textwidth]{./figs/rmawave_1_A50_a30_t500_tauxy_snapshots_dim_printable}
      };%
      \begin{scope}[x={(image.south east)},y={(image.north west)}]%
        \node[font=\small,right] at (0.2,0.9) {$\tau_{xy}$ (Pa)};%
        \node[font=\small,right] at (0.2,0.25) {$t = 2.9~\mu$s };%
  ...
  \end{subfigure}
  \caption[Evolution of the viscous stress field for the $p_a=5$ MPa
  wave]{Evolution of the viscous stress field for the $p_a=5$ MPa
...
%   {\Large Fundamental physical problem:\vspace*{0.2cm}\\ An acoustic wave
...
%       text         = black,] 
%       (T)
%       {\quad \vspace*{0.5cm} Tissue\\ \vspace{-0.1\textwidth}%\\%
%         \hspace*{\fill}
%         \includegraphics[width=0.8\textwidth,angle=-30,origin=c]{./figs/ultrasound_example_transparent_better}
%       };
%       \node [box, right  = 0cm of T, fill = blue!20!white] (A)
%       {\quad Air \vspace*{0.65\textwidth}\\ \quad
%       };
%       \visible<3->{ \draw[<->, line width=1mm] (1,0) -- (2.5,-0.9) node[at start] {\quad\qquad$\nabla p$};}
%       \visible<4->{ \draw[->, line width=1mm] (4,1) -- (2,1) node[at start] {\qquad$\nabla \rho$};}
%     \end{tikzpicture}
%   \end{figure}
%   \pause
%   \only<1-4>{We want to understand the dynamics of this problem}
%   \only<5->{\textbf{Hypothesis:} Ultrasound waves create baroclinic vorticity at gas-liquid interfaces, leading to deformation.}
% \end{frame}
% %
% % \begin{frame}\frametitle{}
...
% %         \includegraphics[width=\textwidth]{./figs/ultrasound_example_transparent_better}
% %       };
% %       \node [box, right  = 0cm of T, fill = blue!20!white] (A)
% %       {\quad Air \vspace*{0.65\textwidth}\\ \quad 
% %       };
% %  %     \draw [scale=0.5, domain=0:2*pi,smooth, variable=\y,blue!20!white, ultra thick] plot ({sin(\y r)},{\y});      
% % %      \fill [scale=0.5, domain=0:2*pi,smooth, variable=\y,blue!20!white, ultra thick, right = 0cm of T] (1,0) plot({sin(\y r)},{\y}) (0,0);
% % %      -- cycle;
% %     \end{tikzpicture}
% %   \end{figure}
% %   \pause
...
%       \pause
%       Linear acoustics can't explain this. Is it vorticity driven?
%     \end{minipage}
%   \end{center}
% \end{frame}
...
%   \vfill
%   \begin{itemize}
%   \item A single pulse can appreciably strain an air-water interface
%     via baroclinic vorticity. Subsequent pulses likely to create more vorticity.\vfill
%   \item Linear acoustics does \textbf{not} capture the dynamics of this problem.\vfill
%   \item Newtonian viscous stress alone is not likely to cause
%     hemorrhage.\vfill  
% %  \item Circulation from subsequent pulses could add up.\vfill
%   \item Better characterization and modeling of mechanical properties (e.g, elasticity, viscosity) is needed.\vfill
%   \end{itemize}
%   \vfill
% \end{frame}
% % 
