...
{\vskip-5pt 
  ...
  \begin{center}
    \vspace*{-0.5cm}
  \hbox{%
  % \begin{beamercolorbox}[wd=\paperwidth,ht=0.4cm,dp=1.35ex]{frametitle}%
  %   \raggedright\hspace*{2em}\vspace*{-.25cm}\insertframetitle %\small{\insertframetitle}
  % \end{beamercolorbox}
   \hspace*{1em}\insertframetitle %\small{\insertframetitle}
  }%
  \end{center}
  \vspace*{-1.25cm}
}
