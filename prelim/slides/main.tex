...
\begin{frame} \frametitle{\vspace*{0.5cm}Background on DUS bioeffects}
  \begin{figure}
    \centering
    \includegraphics[height=0.25\textheight]{./figs/CEUS}\hfill
    \includegraphics[height=0.25\textheight]{./figs/Kidney_Bleed3}\hfill
...
\begin{frame} \frametitle{\vspace*{0.5cm}DUS-induced lung hemorrhage is not a new problem}
  {\small%
    ...
    \end{figure}%
    % 
    \visible<2>{To gain insight into DUS-induced LH, we aim to use computational modeling to study acoustically driven gas-liquid interfaces.}%
    % 
  }
\end{frame}
%% 
...
\begin{frame} \frametitle{\vspace*{0.5cm} Shock-driven fluid-fluid interfaces have been studied extensively}
  {\small
    ...
    \item This problem is not well studied in the acoustic regime.
    \end{itemize}
  }  
\end{frame}
%% 
